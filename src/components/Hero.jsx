...
const Hero = () => {
  return (
    ...
    dark:text-white'>
        ...
        viewport={{once: true}}
        className='text-1xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium
        xl:leading-[95px] max-w-5xl'>Empowering Work with <span 
        className='bg-gradient-to-r from-[#00357a] to-[#4d8cea] bg-clip-text 
        text-transparent'>Intelligent</span> AI Solutions.</motion.h1>
        ...
        75 max-w-4/5 sm:max-w-lg pb-3'>Transforming work with AI-driven solutions that boost innovation and productivity.</motion.p>
